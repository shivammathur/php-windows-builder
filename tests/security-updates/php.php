...
verify(pg_version()['client'] === (PHP_MINOR_VERSION <= 3 ? '14.24' : '16.15'), 'Wrong PostgreSQL client version');
...
echo json_encode(['php' => PHP_VERSION, 'openssl' => OPENSSL_VERSION_TEXT, 'curl_tls' => $curl['ssl_version'], 'libssh2' => $curl['libssh_version'] ?? null, 'pgsql' => pg_version()['client'], 'extensions' => get_loaded_extensions()], JSON_PRETTY_PRINT), "\n";
